...
<?php if ( bbp_is_topic_edit() ) : ?>
	...
	<?php bbp_single_topic_description( [ 'topic_id' => bbp_get_topic_id() ] ); ?>
				...
				<legend>
					...
					if ( bbp_is_topic_edit() ) {
						...
						bbp_is_single_forum() ?
							...
							printf( esc_html__( 'Create New Topic in &ldquo;%s&rdquo;', 'bbpress' ), esc_html( bbp_get_forum_title() ) ) :
				...
				<div>
					...
					<p>
						<label for="bbp_topic_title">
							<?php
							/* translators: %d: Maximum Length of the Topic Title */
							printf( esc_html__( 'Topic Title (Maximum Length: %d):', 'bbpress' ), esc_html( bbp_get_title_max_length() ) );
							?>
						</label><br />
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit">
	...
	<div id="no-topic-<?php bbp_topic_id(); ?>" class="bbp-no-topic">
		<div class="bbp-template-notice">
			<p>
				<?php
				/* translators: %s: Forum Title */
				printf( esc_html__( 'The forum &#8216;%s&#8217; is closed to new topics and replies.', 'bbpress' ), esc_html( bbp_get_forum_title() ) );
				?>
			</p>
		</div>
	</div>
