...
<div id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class( 0, ['thisisyyz__container'] ); ?>>
	...
	<?php if ( !bbp_is_single_forum() || ( bbp_get_topic_forum_id() !== bbp_get_forum_id() ) ) : ?>
        ...
        <div class="bbp-topic-started-in"><?php printf( __( 'in: <a href="%1$s">%2$s</a>', 'bbpress' ), bbp_get_forum_permalink( bbp_get_topic_forum_id() ), bbp_get_forum_title( bbp_get_topic_forum_id() ) ); ?></div>
    ...
    <div class="thisisyyz__column-1">
        ...
        <span class="thisisyyz__author"><?php bbp_topic_author_link( array( 'sep' => '' ) ); ?></span>
